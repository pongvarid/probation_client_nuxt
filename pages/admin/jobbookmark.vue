<template>
    <div class="bbg">
        ...
        </v-btn><h2 class="text-xl font-semibold">บุคคลที่สนใจ </h2>
            <span>Engineer / Engineer Project **ยินดีรับนักศึกษาจบใหม่**/วิศวกร / วิศวกรโครงการ</span>
         
        </div> 
     
        <div class="p-4">
            <v-card @click="$router.push(`/admin/search/detail/`)">
                <v-card-text>
