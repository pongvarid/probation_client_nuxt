...
<div class="llbg">
  <center>
    ...
    <span class="font-semibold">ยินดีต้อนรับ ระบบจัดหางานผู้ถูกคุมประพฤติ</span>
  </center>
  <div class="p-4">
    <v-card outlined>
        <v-card-text>
    ...
    <v-btn class="mt-6" outlined depressed block @click="$router.push(`/auth/adminlogin/`)" color="primary">เข้าสู่ระบบผู้ประกอบการ</v-btn>
  </div>
