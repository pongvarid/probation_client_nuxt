<template>
  <div>
    <v-toolbar color="transparent" flat class="mt-4">
      ...
      <v-spacer></v-spacer>
      <v-btn depressed small @click="dialog = true" color="success"
        >เพิ่มตำแหน่งงาน</v-btn
      >
    </v-toolbar>
        ...
        <v-card-text>
          ...
          <v-form ref="vform" class="mt-4">
            ...
            <v-autocomplete
              ...
              outlined
              dense
              :items="$auth.getSubCategoryByCategory(form.category)"
              item-text="name"
              item-value="id"
              label="ประเภทของงาน"
            ></v-autocomplete>
            ...
            <v-textarea
              ...
              dense
              textarea
              label="รายละเอียดของงาน เงื่อนไข คุณสมบัติ สวัสดิการ"
              placeholder="รายละเอียดของงาน เงื่อนไข คุณสมบัติ สวัสดิการ"
            ></v-textarea>
            <v-checkbox
              v-model="form.approve"
              label="ยินดียอมรับผู้เคยมีประวัติดำเนินคดี"
            ></v-checkbox>
            <v-btn
              @click="form.id ? updateJob() : storeJob()"
              block
              depressed
              color="success"
              >บันทึก</v-btn
